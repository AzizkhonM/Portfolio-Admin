...
import { useLogin } from "../../service/login/index";
...
const authorize = async () => {
  if (loginInfo.login == "" || loginInfo.password == "") {
    toast.error("Maydonlar to'liq to'ldirilmagan");
  } else {
    try {
      const res = await useLogin.login(loginInfo);
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          name: res?.data?.Admin.first_name,
        })
      );
  ...
  <div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
    ...
    >
      <div class="md:flex w-full">
        <div class="hidden md:block w-1/2 bg-[#457BC8] py-10 px-10">
          <svg
        ...
        <div class="w-full grid grid-cols-1 items-stretch md:w-1/2 py-10 px-5 md:px-10">
          ...
          <div>
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <label for="" class="text-xs font-semibold px-1">Login</label>
                <div class="flex">
                  <div
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <button
                  @click="authorize"
                  class="block duration-300 w-full max-w-xs mx-auto bg-[#457BC8] hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
                >
                  REGISTER NOW
                </button>
              </div>
